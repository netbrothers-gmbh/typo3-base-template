...
class IconService
{
    ...
    {
        $iconSets = [];
        $iconSets[] = ['LLL:EXT:nb_basetemplate/Resources/Private/Language/Backend.xlf:option.none', ''];
    ...
    public function getIconItems(array &$configuration): void
    {
        $iconItems = [];
        $iconItems[] = [
            'LLL:EXT:nb_basetemplate/Resources/Private/Language/Backend.xlf:option.none',
            0,
            'EXT:nb_basetemplate/Resources/Public/Images/Icons/none.svg',
        ];
    ...
    public function getIconProviders(): array
    {
        ...
        if (isset($GLOBALS['TYPO3_CONF_VARS']['SC_OPTIONS']['ext/typo3-base-template/icons']['provider'])
            && is_array($GLOBALS['TYPO3_CONF_VARS']['SC_OPTIONS']['ext/typo3-base-template/icons']['provider'])
        ) {
            foreach ($GLOBALS['TYPO3_CONF_VARS']['SC_OPTIONS']['ext/typo3-base-template/icons']['provider'] as $className) {
