 ...
 * Basic Example:
 *
 * 10 = NetBrothers\TYPO3BaseTemplate\DataProcessing\SkiplinkProcessor
 * 10 {
 *   entries {
 *     mainnavigation {
 *       label = LLL:EXT:nb_basetemplate/Resources/Private/Language/locallang.xlf:skiptomainnavigation
 *       section = mainnavigation
 *       priority = 20
 *     }
 *     content {
 *       label = LLL:EXT:nb_basetemplate/Resources/Private/Language/locallang.xlf:skiptocontent
 *       section = page-content
 *       priority = 10
 *     }
 *     footer {
 *       label = LLL:EXT:nb_basetemplate/Resources/Private/Language/locallang.xlf:skiptofooter
 *       section = page-footer
 *       priority = 0
 *     }
 *   }
