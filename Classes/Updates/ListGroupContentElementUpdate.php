...
class ListGroupContentElementUpdate extends AbstractUpdate implements UpgradeWizardInterface, RepeatableInterface
{
     ...
     * @var string
     */
    protected $title = 'EXT:nb_basetemplate: Migrate list group content element';
    ...
    public function updateNecessary(): bool
    {
        ...
        $criteria = [$this->createEqualStringCriteria($queryBuilder, $this->field, 'nb_basetemplate_listgroup')];
