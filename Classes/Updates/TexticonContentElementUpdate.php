...
class TexticonContentElementUpdate extends AbstractUpdate implements UpgradeWizardInterface, RepeatableInterface
{
     ...
     * @var string
     */
    protected $title = 'EXT:nb_basetemplate: Migrate text and icon content element';
    ...
    public function updateNecessary(): bool
    {
        ...
        $criteria = [$this->createEqualStringCriteria($queryBuilder, $this->field, 'nb_basetemplate_texticon')];
