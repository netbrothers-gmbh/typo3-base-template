...
CREATE TABLE tt_content (
    ...
    tx_nbbasetemplate_card_group_item int(11) unsigned DEFAULT '0',
    tx_nbbasetemplate_carousel_item int(11) unsigned DEFAULT '0',
    tx_nbbasetemplate_accordion_item int(11) unsigned DEFAULT '0',
    tx_nbbasetemplate_icon_group_item int(11) unsigned DEFAULT '0',
    tx_nbbasetemplate_tab_item int(11) unsigned DEFAULT '0',
    tx_nbbasetemplate_timeline_item int(11) unsigned DEFAULT '0',
...
--
-- Table structure for table 'tx_nbbasetemplate_card_group_item'
--
CREATE TABLE tx_nbbasetemplate_card_group_item (
...
--
-- Table structure for table 'tx_nbbasetemplate_carousel_item'
--
CREATE TABLE tx_nbbasetemplate_carousel_item (
    tt_content int(11) unsigned DEFAULT '0',
...
--
-- Table structure for table 'tx_nbbasetemplate_accordion_item'
--
CREATE TABLE tx_nbbasetemplate_accordion_item (
    tt_content int(11) unsigned DEFAULT '0',
    header varchar(255) DEFAULT '' NOT NULL,
    bodytext text,
...
--
-- Table structure for table 'tx_nbbasetemplate_icon_group_item'
--
CREATE TABLE tx_nbbasetemplate_icon_group_item (
     tt_content int(11) unsigned DEFAULT '0',
    header varchar(255) DEFAULT '' NOT NULL,
    subheader varchar(255) DEFAULT '' NOT NULL,
    bodytext text,
...
--
-- Table structure for table 'tx_nbbasetemplate_tab_item'
--
CREATE TABLE tx_nbbasetemplate_tab_item (
    tt_content int(11) unsigned DEFAULT '0',
    header varchar(255) DEFAULT '' NOT NULL,
    bodytext text,
    media int(11) unsigned DEFAULT '0',
...
--
-- Table structure for table 'tx_nbbasetemplate_timeline_item'
--
CREATE TABLE tx_nbbasetemplate_timeline_item (
    tt_content int(11) unsigned DEFAULT '0',
    date datetime,
    header varchar(255) DEFAULT '' NOT NULL,
    bodytext text,
