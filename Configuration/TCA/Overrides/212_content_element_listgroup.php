...
\TYPO3\CMS\Core\Utility\ExtensionManagementUtility::registerPageTSConfigFile(
    ...
    'TYPO3 Base Template Content Element: List Group'
);
...
\TYPO3\CMS\Core\Utility\ExtensionManagementUtility::addTcaSelectItem(
    ...
    'CType',
    [
        'label' => 'LLL:EXT:nb_basetemplate/Resources/Private/Language/Backend.xlf:content_element.listgroup',
        'description' => 'LLL:EXT:nb_basetemplate/Resources/Private/Language/Backend.xlf:content_element.listgroup.description',
        'value' => 'listgroup',
        'icon' => 'content-nbbasetemplate-listgroup',
...
// Assign Icon
$GLOBALS['TCA']['tt_content']['ctrl']['typeicon_classes']['listgroup'] = 'content-nbbasetemplate-listgroup';
