...
$GLOBALS['TCA']['pages']['columns'] = array_replace_recursive(
    ...
    [
        ...
        'nav_icon' => [
            'label' => 'LLL:EXT:nb_basetemplate/Resources/Private/Language/Backend.xlf:pages.nav_icon',
        ...
        'thumbnail' => [
            'exclude' => true,
            'label' => 'LLL:EXT:nb_basetemplate/Resources/Private/Language/Backend.xlf:pages.thumbnail',
            'config' => [
                'type' => 'file',
