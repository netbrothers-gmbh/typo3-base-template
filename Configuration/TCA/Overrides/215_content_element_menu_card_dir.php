...
\TYPO3\CMS\Core\Utility\ExtensionManagementUtility::registerPageTSConfigFile(
    ...
    'TYPO3 Base Template Content Element: Menu Cards of subpages'
);
...
\TYPO3\CMS\Core\Utility\ExtensionManagementUtility::addTcaSelectItem(
    ...
    'CType',
    [
        'label' => 'LLL:EXT:nb_basetemplate/Resources/Private/Language/Backend.xlf:menu.card_dir',
        'description' => 'LLL:EXT:nb_basetemplate/Resources/Private/Language/Backend.xlf:menu.card_dir.description',
        'value' => 'menu_card_dir',
        'icon' => 'content-nbbasetemplate-menu-card',
...
// Assign Icon
$GLOBALS['TCA']['tt_content']['ctrl']['typeicon_classes']['menu_card_dir'] = 'content-nbbasetemplate-menu-card';
    ...
    [
        'showitem' => '
            --div--;LLL:EXT:core/Resources/Private/Language/Form/locallang_tabs.xlf:general,
                ...
                readmore_label,
            --div--;LLL:EXT:nb_basetemplate/Resources/Private/Language/Backend.xlf:menu.card.options,
...
\TYPO3\CMS\Core\Utility\ExtensionManagementUtility::addPiFlexFormValue(
    '*',
    'FILE:EXT:nb_basetemplate/Configuration/FlexForms/MenuCard.xml',
    'menu_card_dir'
);
