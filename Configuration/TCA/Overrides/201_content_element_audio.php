...
\TYPO3\CMS\Core\Utility\ExtensionManagementUtility::registerPageTSConfigFile(
    ...
    'TYPO3 Base Template Content Element: Audio'
);
...
\TYPO3\CMS\Core\Utility\ExtensionManagementUtility::addTcaSelectItem(
    ...
    'CType',
    [
        'label' => 'LLL:EXT:nb_basetemplate/Resources/Private/Language/Backend.xlf:content_element.audio',
        'description' => 'LLL:EXT:nb_basetemplate/Resources/Private/Language/Backend.xlf:content_element.audio.description',
        'value' => 'audio',
        'icon' => 'content-audio',
