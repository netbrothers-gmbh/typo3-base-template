...
\TYPO3\CMS\Core\Utility\ExtensionManagementUtility::registerPageTSConfigFile(
    ...
    'TYPO3 Base Template Content Element: Menu Cards'
);
...
\TYPO3\CMS\Core\Utility\ExtensionManagementUtility::addTcaSelectItem(
    ...
    'CType',
    [
        'label' => 'LLL:EXT:nb_basetemplate/Resources/Private/Language/Backend.xlf:menu.card_list',
        'description' => 'LLL:EXT:nb_basetemplate/Resources/Private/Language/Backend.xlf:menu.card_list.description',
...
// Assign Icon
$GLOBALS['TCA']['tt_content']['ctrl']['typeicon_classes']['menu_card_list'] = 'content-nbbasetemplate-menu-card';
