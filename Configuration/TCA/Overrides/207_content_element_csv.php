...
\TYPO3\CMS\Core\Utility\ExtensionManagementUtility::registerPageTSConfigFile(
    ...
    'TYPO3 Base Template Content Element: CSV'
);
...
\TYPO3\CMS\Core\Utility\ExtensionManagementUtility::addTcaSelectItem(
    ...
    'CType',
    [
        'label' => 'LLL:EXT:nb_basetemplate/Resources/Private/Language/Backend.xlf:content_element.csv',
        'description' => 'LLL:EXT:nb_basetemplate/Resources/Private/Language/Backend.xlf:content_element.csv.description',
        'value' => 'csv',
        'icon' => 'content-nbbasetemplate-csv',
...
// Assign Icon
$GLOBALS['TCA']['tt_content']['ctrl']['typeicon_classes']['csv'] = 'content-nbbasetemplate-csv';
